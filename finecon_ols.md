...
Our first hypothesis for this case study is that Monday return is negative and ur second hypothesis is that Friday return is positive.
* Ho : Monday Return ≥ 0
* Ha : Monday Return < 0
* Ho : Friday Return ≤ 0
* Ha : Friday Return > 0
...
### Conclusion 
* None of the coefficients are statistically significant (all p-values > 0.05), meaning we cannot confidently say these differences are real rather than random noise. Moreover, we fail to reject H₀. 
